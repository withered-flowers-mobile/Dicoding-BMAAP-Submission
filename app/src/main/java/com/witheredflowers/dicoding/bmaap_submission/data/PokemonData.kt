    ...
    private val data =
        listOf(
            Pokemon(
                ...
                "overgrow", "Strengthens grass moves to inflict 1.5× damage\nat 1/3 max HP or less.",
                45, 49, 49, 65, 65, 45,
                "grass", "poison"
            ),
            Pokemon(
            ...
            Pokemon(
                ...
                "solar-power", "Increases Special Attack to 1.5× but\ncosts 1/8 max HP after each turn during strong sunlight.",
                "blaze", "Strengthens fire moves to inflict 1.5× damage\nat 1/3 max HP or less.",
                39, 52, 43, 60, 50, 65,
                "fire", "-"
            ),
            Pokemon(
            ...
            Pokemon(
                ...
                "rain-dish", "Heals for 1/16 max HP after each turn\nduring rain.",
                "torrent", "Strengthens water moves to inflict 1.5× damage\nat 1/3 max HP or less.",
                44, 48, 65, 50, 64, 43,
                "water", "-"
            ),
            Pokemon(
            ...
            Pokemon(
                ...
                "shed-skin", "Has a 33% chance of curing any major\nstatus ailment after each turn.",
                "-", "-",
                50, 20, 55, 25, 25, 30,
                "bug", "-"
            ),
            Pokemon(
                ...
                "tinted-lens", "Doubles damage inflicted with\nnot-very-effective moves.",
                "compound-eyes", "Has 1.3× their accuracy. No effect on the\none-hit KO moves (fissure, guillotine, horn drill,\nand sheer cold).",
                60, 45, 50, 90, 80, 70,
                "bug", "flying"
            )
        )
